...
H.apply_config = function(config)
  ...
  local m = function(mode, lhs, rhs, desc) H.map(mode, lhs, rhs, { expr = true, desc = 'Mini Surround: ' .. desc }) end

  m('n', maps.add, H.make_operator('add', nil, true), 'Add')
  H.map('x', maps.add, ':<C-u>lua MiniSurround.add("visual")<CR>', { desc = 'Mini Surround: Add to Selection' })

  m('n', maps.delete,   H.make_operator('delete', nil),    'Delete')
  m('n', maps_l.delete, H.make_operator('delete', 'prev'), 'Delete Previous')
  m('n', maps_n.delete, H.make_operator('delete', 'next'), 'Delete Next')

  m('n', maps.replace,   H.make_operator('replace', nil),    'Replace')
  m('n', maps_l.replace, H.make_operator('replace', 'prev'), 'Replace Previous')
  m('n', maps_n.replace, H.make_operator('replace', 'next'), 'Replace Next')

  m('n', maps.find,   H.make_action('find', 'right', nil),    'Find Right')
  m('x', maps.find,   H.make_action('find', 'right', nil),    'Find Right')
  m('o', maps.find,   H.make_action('find', 'right', nil),    'Find Right')
  m('n', maps_l.find, H.make_action('find', 'right', 'prev'), 'Find Previous Right')
  m('x', maps_l.find, H.make_action('find', 'right', 'prev'), 'Find Previous Right')
  m('o', maps_l.find, H.make_action('find', 'right', 'prev'), 'Find Previous Right')
  m('n', maps_n.find, H.make_action('find', 'right', 'next'), 'Find Next Right')
  m('x', maps_n.find, H.make_action('find', 'right', 'next'), 'Find Next Right')
  m('o', maps_n.find, H.make_action('find', 'right', 'next'), 'Find Next Right')

  m('n', maps.find_left,   H.make_action('find', 'left', nil),    'Find Left')
  m('x', maps.find_left,   H.make_action('find', 'left', nil),    'Find Left')
  m('o', maps.find_left,   H.make_action('find', 'left', nil),    'Find Left')
  m('n', maps_l.find_left, H.make_action('find', 'left', 'prev'), 'Find Previous Left')
  m('x', maps_l.find_left, H.make_action('find', 'left', 'prev'), 'Find Previous Left')
  m('o', maps_l.find_left, H.make_action('find', 'left', 'prev'), 'Find Previous Left')
  m('n', maps_n.find_left, H.make_action('find', 'left', 'next'), 'Find Next Left')
  m('x', maps_n.find_left, H.make_action('find', 'left', 'next'), 'Find Next Left')
  m('o', maps_n.find_left, H.make_action('find', 'left', 'next'), 'Find Next Left')

  m('n', maps.highlight,   H.make_action('highlight', nil, nil),    'Highlight')
  m('n', maps_l.highlight, H.make_action('highlight', nil, 'prev'), 'Highlight Previous')
  m('n', maps_n.highlight, H.make_action('highlight', nil, 'next'), 'Highlight Next')
end
